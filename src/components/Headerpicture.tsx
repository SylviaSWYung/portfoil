export function Headerpicture(){
    return(
        <div className="absolute top-20 z-0 inset-0 w-8/12 h-8/12" style={{paddingBottom: "56.25%"}}>
            <svg viewBox="21.458 89.244 474.718 317.066"  xmlns="http://www.w3.org/2000/svg" className="">
